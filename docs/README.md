...
2. [Game rules](product/game-rules.md)
3. [System overview](architecture/overview.md)
4. [Authentication architecture](architecture/authentication.md)
5. [Realtime connections and gameplay lease](architecture/realtime-connections.md)
6. [API and WebSocket contract](contracts/api-websocket-contract.md)
7. The relevant frontend or backend implementation guide
